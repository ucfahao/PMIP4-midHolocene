...
|8|Y| Charlie Williams | | Overview of midHolocene orbital conditions |
|9|N| | | Discussion of GHG concentrations and aerosols. Changes from PMIP3|
|10|N| | | Discussion of land cover specifications. State variety of ways to encode into GCMs. Role of dynamic veg (relate back to piControl specifications and DECK).|
|11|Y|Chris | | Introduce CMIP6 and DECK. Data available for download on ESGF. PMIP4 simulations are open to non-CMIP6 models, process for securing data not as obvious.|
|12|Y|Chris | | Describe some basic ensemble features of PMIP4. Refer to Table \ref{tab:gcms}. Specify inclusion criteria.|
|13|Y|Chris | | Brief discussion of PMIP3 - stress no individual models identified here, so reference previous papers for that info|
|14|Y|Chris | | Explain issue with calendar changes. Stress often not adjusted for in previous studies.|
